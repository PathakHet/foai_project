...
class Game:
    ...
    def run(self):
        ...
        self.numMoves = 0
        max_total_moves = getattr(self.rules, "max_moves", None)
        step_count = 0
        ...
        while not self.gameOver:
            ...
            if agentIndex == numAgents + 1:
                self.numMoves += 1
            step_count += 1
            if max_total_moves is not None and step_count >= max_total_moves and not self.gameOver:
                # End the game due to timeout without forcing a hard loss flag.
                self.gameOver = True
                break
            # Next agent
